...
<html>
    ...
    <body>
        ...
        <div class="title1">
            <h2 align="center" ><b>What is General Surgery?</b></h2>
        </div>
        <div class="colour">
        <div class="wrapper1">
            <img src="images/surgery.jpg" height="300px"
                width="350px"></img>
            <div class="text1"><p><b>General surgery is a branch of surgery that focuses on the digestive system and abdominal organs, 
                such as the thyroid gland and the oesophagus, stomach, small and large intestines, liver, pancreas, gallbladder, appendix, and bile ducts.</b></p></div>
        </div>
        <label id="select">Our Specialist </label>

        <?php
            include("conn.php");
            $sql = "SELECT * FROM doctorlist WHERE doctor_speciality='General Surgery'";
