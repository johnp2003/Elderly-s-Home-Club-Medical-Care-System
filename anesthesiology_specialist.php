...
<html>
    ...
    <body>
        ...
        <div class="title1">
            <h2 align="center" ><b>What is Anesthesiology?</b></h2>
        </div>
        <div class="colour">
        <div class="wrapper1">
            <img src="images/anesthesiology.jpg" height="300px"
                width="350px"></img>
            <div class="text1"><p><b>Vital bodily processes including respiration, blood pressure, body temperature, and fluid balance are monitored and managed for the patient.
To create the best environment for a safe and effective operation, manage the patient's pain and degree of awareness.</b></p></div>
        </div>
        <label id="select">Our Specialist </label>

        <?php
            $con = mysqli_connect("localhost","root","","elderly_database");
            $sql = "SELECT * FROM doctorlist WHERE doctor_speciality='Anesthesiology'";
