...
<html>
    ...
    <nav class="navbar navbar-expand-lg bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav">
                      ...
                      <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                          <li><a class="dropdown-item active" href="#">Manage Appointment Request</a></li>
        ...
        <br>
        <p>Manage Appointment List (Accept/Reject)</p>
        <?php
        $searchkeyword = "";
        ...
        <?php
            ...
            OR request_speciality LIKE '%".$searchkeyword."%' OR pat_id LIKE '%".$searchkeyword."%' OR doc_id LIKE '%".$searchkeyword."%') AND status='Pending'";
        ...
        <div>
            <table style="width: 90%;">
                <tr>
                    ...
                    <th>Time Slot</th>
                    <th>Status</th>
                    <th class="text">Add Doc</th>
                    <th class="text">Accept</th>
                    <th class="text">Reject</th>
                </tr>
                <?php
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        echo '<td class="link"><a href="edit_suggest_appointment.php?appoint_id='.$row['appoint_id'].'" id="edit">Assign Doctor</a></td>';
                        echo '<td class="link"><a href="accept_patient_appointment_admin.php?appoint_id='.$row['appoint_id'].'" id="edit" ><button type="submit" bame class="btn btn-success">Accept</button></a></td>';
                        echo '<td class="link"><a href="delete_rejected_appointment_admin.php?appoint_id='.$row['appoint_id'].'"onclick="return confirm(\'Delete appointment ID '.$row['appoint_id'].'?\');"><button type="button" class="btn btn-danger">Reject</button></a></td>';
                        echo "</tr>";
                    }
                    mysqli_close($con);
                ?>
