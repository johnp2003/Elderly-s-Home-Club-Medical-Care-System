...
<html>
    ...
    <body>
        ...
        {
        ?>
        <div class="title"><p>Editing Patient Appointment</p></div>
        
        <div class="details">
                <form action="update_patient_appointment_admin" method="post">
                <input type="hidden" name="appoint_id" value="<?php echo $row['appoint_id'] ?>">
                    <div class="form">
                        <label>APP ID:</label><br>
                        <input type="text" value="<?php echo $row['appoint_id'] ?>" placeholder="Enter Appointment ID" name="appoint_id">
                    </div>
                    <br>
                    <div class="form">
