...
<html>
    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" href="contect_us.php">Contact Us</a>
                      </li>
                      <li class="nav-item">
        ...
        <div class="title1">
            <h2 align="center" ><b>What is Pathology?</b></h2>
        </div>
        <div class="colour">
        <div class="wrapper1">
            <img src="images/pathology.jpg" height="300px"
                width="350px"></img>
            <div class="text1"><p><b>The study of the nature and causes of illnesses is the focus of the medical discipline known as pathology.
It serves as the foundation for all medical practises, including cutting-edge genetic research, blood transfusion techniques, and chronic illness monitoring.
 </b></p></div>
        </div>
        ...
        <?php
            include("conn.php");
            $sql = "SELECT * FROM doctorlist WHERE doctor_speciality='Pathology'";
