<?php
    ...
    if(isset($_SESSION["admin_id"])){
        ...
        mysqli_close($con);
        echo '<script>alert("Record updated!");window.location.href="manage_patient_appointment_admin.php";</script>';
        }else{
            echo '<script>alert("Invalid Input!");window.location.href="manage_patient_appointment_admin.php";</script>';
        }
    }else {
